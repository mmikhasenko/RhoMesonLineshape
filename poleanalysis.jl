...
# ╔═╡ df9bf564-0abe-4b60-8483-7f4817986119
using Plots

# ╔═╡ cbff8682-2056-11ec-0727-d3ff68b85b97
using LaTeXStrings

# ╔═╡ 64b37a3e-a59c-4b03-ba9a-ae5b0cdc16af
using Measurements

# ╔═╡ d101d348-2b82-4d19-9ae6-7d0b290712cb
using JLD2

# ╔═╡ eb9c025e-f664-4677-8948-ed0d58aeb141
using Optim
...
md"""
Quantum amplitude for two particles resonance interaction:

${\frak M}(e|m,Γ) = \frac{1}{m^2-e^2-i m\Gamma}$

Intensity of scattering observed in experiment:

$I = \left|\frak{M}\right|^2 \Phi(e)$

``\Phi(e)`` is phase space, the number of configurations

"""

# ╔═╡ d1b102fe-5fd2-4cbb-8693-62d6d7592aca
md"""
PDG: data on the resonances. [Here is the ``\rho`` methon](https://pdglive.lbl.gov/Particle.action?init=0&node=M009&home=MXXX005)
"""
...
convert resonance parameters to the pole position.

1. For a simple model of constance width
2. For advanced model of energy-dep width
...
# M(e) = 1/(mρ_pdg^2-e^2-1im*mρ_pdg.val*Γρ_pdg)
...
# ╔═╡ ddcf6d5c-1102-4782-87a0-4710a6cf0cc1
phasespace(e) = sqrt(1-4mπ^2/e^2)

# ╔═╡ 18b1488e-3167-40cb-98c1-b642146433eb
plot(phasespace, 2mπ, 1.5)

# ╔═╡ f9d661d2-7edd-4deb-b3f7-222c0d64bef1
md"""
### First model (naive)
"""

# ╔═╡ 8fa5afa2-67e2-4743-b06c-20041240078c
begin
...
# ╔═╡ 8508d011-ac4d-4f53-a0b4-82ae1ddfd255
optimresult = optimize(x->abs2(1/amplitude(a1,x[1]+1im*x[2])), [mρ_pdg, Γρ_pdg/2])

# ╔═╡ 005f0385-53aa-4651-abfe-3b8404e0e9e8
Optim.minimizer(optimresult)

# ╔═╡ c52d5186-d206-4545-a3ee-284a81dc8bc2
...
# ╔═╡ 870bcb3a-3596-432c-b791-0f731a5df186
pole_search(a1)

# ╔═╡ 6964a529-91fb-4d4c-a614-f7b68c599624
pole_search(a0)

# ╔═╡ 4746b2e9-45af-49dc-84af-d6574faa3227
md"""
## Propagate the uncertainties
"""

# ╔═╡ 9b9fdf64-03f4-463b-b9be-cc353d8e852f
constwidth_pole_sample = [pole_search(constwidthappr(
		mρ_pdg.val+randn()*mρ_pdg.err,
		Γρ_pdg.val+randn()*Γρ_pdg.err)) for _ in 1:1000]

# ╔═╡ 59e241a7-52e7-49cd-bc0a-b22b2c1a43c8
depwidth_pole_sample = [pole_search(depwidthapprox(
		mρ_pdg.val+randn()*mρ_pdg.err,
		Γρ_pdg.val+randn()*Γρ_pdg.err)) for _ in 1:1000]

# ╔═╡ 1f477727-e1cb-48b9-ac57-b0e5a2bda722
begin
